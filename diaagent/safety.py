"""Правила безопасности для учебного прототипа DiaAgent."""
...
EDUCATIONAL_WARNING = (
    "Это учебный расчёт, а не медицинская рекомендация. Не изменяйте лечение "
...
def check_safety(
    ...
    """Возвращает список предупреждений для учебного расчёта."""
    warnings = []
